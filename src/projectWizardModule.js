 ...
 * Reusable module for creating and editing projects
 */
...
export class ProjectWizard {
    ...
    init() {
        ...
        // Don't load voices immediately - wait until step 2 is shown
    ...
    render() {
        ...
        if (!container) {
            console.error('Project wizard container not found:', this.containerId);
            return;
        }
